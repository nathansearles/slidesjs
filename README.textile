...
* "http://slidesjs.com/examples/images-with-captions/":Images with captions
* "http://slidesjs.com/examples/linking/":Linking
* "http://slidesjs.com/examples/product/":Product
* "http://slidesjs.com/examples/multiple/":Multiple slideshows
* "http://slidesjs.com/examples/simple/":Simple (unstyled)
* "http://slidesjs.com/examples/standard/":Standard
...
* New: Auto centered pagination
* Fix: Fix for IE flicker issue
