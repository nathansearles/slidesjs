...
Created by "http://nathansearles.com":http://nathansearles.com
...
h2. Changelog
* 2.0 beta 1+
** Ability to change the position of navigation and pagination (prepend or append) 
** Customizable class names 
** Customizable navigation buttons text 
** Option to disable buttons when first or last (limit) 
** Implemented crossfade 
** Implemented autoheight 
** Div holder for navigation buttons 
** Support for naming of the pagination (by adding title attribute to the nav elements) 
** Added demo showing the newly implemented features
