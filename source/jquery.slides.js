...
(function() {
  (function($, window, document) {
    ...
    Plugin.prototype._touchend = function(e) {
      var $element, duration, prefix, sensitivity, slidesControl, timing, touches, transform;
      $element = $(this.element);
      this.data = $.data(this);
      touches = e.originalEvent.touches[0];
      sensitivity = 10;
      ...
      if (slidesControl.position().left > sensitivity || slidesControl.position().left > this.options.width * 0.1 && (Number(new Date()) - this.data.touchtimer < 250)) {
        $.data(this, "direction", "previous");
        this._slide();
      } else if (slidesControl.position().left < -sensitivity || slidesControl.position().left < -(this.options.width * 0.1) && (Number(new Date()) - this.data.touchtimer < 250)) {
        $.data(this, "direction", "next");
        this._slide();
      } else {
        ...
        setTimeout(function() {
          return slidesControl.trigger('transitionend');
    ...
    Plugin.prototype._slide = function(number) {
      ...
      if (!this.data.animating && number !== this.data.current + 1) {
        ...
        this.options.callback.start(next + 1);
